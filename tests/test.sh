...
# Working
SKIP_FILES=("win64" "arena" "util" "type" "array" "ir_util" "logger" "tokenizer" "x86_gen" "main" "compiler" "node" "const_expr")
# Not working
#SKIP_FILES=("sysv" "analysis" "sema" "node" "ir_builder" "ir_module" "ir_gen" "parser" "x86_emit")
