...
# Working
SKIP_FILES=("win64" "main" "compiler" "x86_gen" "x86_emit" "tokenizer" "logger" "ir_util" "node" "array" "type" "util" "arena" "const_expr")
# Not working
#SKIP_FILES=("sysv" "analysis" "sema" "ir_builder" "ir_module" "ir_gen" "parser")
